        ...
        <div class="cs-invoice_in" id="download_section">
            <div class="cs-invoice_head cs-type1 cs-mb25" style="height:60px;">
                <div class="cs-invoice_left">
                    <p class="cs-invoice_number cs-primary_color cs-mb5 cs-f16"><b class="cs-primary_color">Αριθμός Είσπραξης :</b> #{{$data->receipt_number}}</p>
                    <p class="cs-invoice_date cs-primary_color cs-m0"><b class="cs-primary_color">Ημερομηνία : </b>{{date('d M Y', strtotime($data->receipt_date))}}</p>
                </div>
            </div>
            <div class="cs-invoice_head cs-mb10" style="min-height:125px;">
                <div class="cs-invoice_left">
                    <b class="cs-primary_color">Παραλαβή προς :</b>
                    <p>
                        {{$data->client->name}}
                ...
                <div class="cs-invoice_right cs-text_right">
                    <b class="cs-primary_color">Πληρωμή :</b>
                    <p>
                        {{$data->client->name}}
                ...
                <div class="cs-round_border">
                    <div class="cs-table_responsive">
                        <table>
                            <thead>
                            <tr >
                                <th class="cs-width_2 cs-primary_color cs-focus_bg">Παρατήρηση</th>
                                <th class="cs-width_3 cs-primary_color cs-focus_bg">Σημείωση</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                    ...
                    <div class="cs-right_footer">
                        <table>
                            ...
                            <tr class="cs-border_none">
                                <td class="cs-width_3 cs-border_top_0 cs-bold cs-f16 cs-primary_color">Ποσό</td>
