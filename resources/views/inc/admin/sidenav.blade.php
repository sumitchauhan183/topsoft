    ...
    <div class="collapse navbar-collapse  w-auto"  id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          ...
          <li class="nav-item">
              <a class="nav-link text-white @if($main=='profile') active bg-gradient-primary @endif " href="{{route('admin.profile')}}">
        ...
        <a class="nav-link text-white  @if($main=='receipts') active bg-gradient-primary @endif"  href="{{route('admin.receipts.list')}}">
          ...
          <li class="nav-item">
              <a class="nav-link text-white  @if($main=='events') active bg-gradient-primary @endif"  href="{{route('admin.events.list')}}">
