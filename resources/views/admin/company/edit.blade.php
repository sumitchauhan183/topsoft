          ...
          <div class="card my-4">
            ...
            <div class="ms-md-auto pe-md-3 d-flex align-items-center mb-4">
                            <div class="input-group input-group-outline mx-3 focused is-focused">
                                ...
                                <input type="text" class="form-control" id="name" value="{{$company->name}}" autocomplete="off">
                                <input type="hidden" class="form-control" id="company_id" value="{{$company->company_id}}" autocomplete="off">
                            </div>
                            <div class="input-group input-group-outline mx-3 focused is-focused">
                                <label class="form-label">Greek Name</label>
                                <input type="text" class="form-control" id="greek-name"  value="{{$company->greek_name}}" autocomplete="off">
                            </div>
