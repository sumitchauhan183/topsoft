                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="ms-md-auto pe-md-3 d-flex align-items-center mb-4">
                            <div class="input-group input-group-outline mx-3 focused is-focused">
                                ...
                                <input type="text" class="form-control" id="name" value="{{$admin->name}}" autocomplete="off">
                            </div>
                            <div class="input-group input-group-outline mx-3 focused is-focused">
                                <label class="form-label">Email</label>
                                <input type="text" class="form-control" id="email" value="{{$admin->email}}" autocomplete="off">
                            </div>
                            <div class="input-group input-group-outline mx- focused is-focused">
                                <label class="form-label">Password</label>
                                <input type="password" class="form-control" id="password" value="" autocomplete="off">
                            </div>
                        </div>
                        <div class="sidenav-footer w-100 bottom-0 ">
                            <div class="mx-3 text-center">
                                <button class="btn bg-gradient-primary mt-4 w-40" id="update-profile"  type="button">Update</button>
                            </div>
                        </div>
                    </div>
