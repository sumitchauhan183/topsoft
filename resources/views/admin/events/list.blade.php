            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0 mx-4">
                <table class="table align-items-center justify-content-center mb-0" id="event_table">
                  <thead>
                    <tr>
                    <th class="text-uppercase  text-xxs font-weight-bolder opacity-7">Event ID</th>
                      <th class="text-uppercase  text-xxs font-weight-bolder opacity-7">Type</th>
                      ...
                      <th class="text-uppercase  text-xxs font-weight-bolder opacity-7 ps-2">Event Date</th>
