    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Company > Add New App User</h6>
        </nav>
            ...
            <div class="card-body px-0 pb-2">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center mb-4">
                      <input type="hidden" id="company-id" value="{{$company_id}}">
                            <div class="input-group input-group-outline mx-3">
                                ...
                                <input type="email" class="form-control" id="email-new" autocomplete="new-email">
                            </div>
                            <div class="input-group input-group-outline mx-3">
                                <label class="form-label">Password</label>
                                <input type="password" class="form-control" id="password-new" autocomplete="new-password">
                            </div>
                    ...
                    <div class="sidenav-footer w-100 bottom-0 ">
                        <div class="mx-3 text-center">
                            <button class="btn bg-gradient-primary mt-4 w-40 " id="add-device" type="button">Add</button>
                        </div>
                    </div>
