    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Company > App User > View</h6>
        </nav>
          ...
          <div class="card my-4">
            ...
            <div class="ms-md-auto pe-md-3 d-flex align-items-center mb-4">
                            <div class="input-group input-group-outline mx-3 focused is-focused">
                                ...
                                <input type="text" class="form-control" id="name" readonly value="{{$devices->email}}" readonly>
                            </div>
                            <div class="input-group input-group-outline mx-3 focused is-focused">
                                <label class="form-label">Status</label>
                                <input type="text" class="form-control" id="greek-name" value="{{$devices->status}}" readonly >
                            </div>
                    </div>
